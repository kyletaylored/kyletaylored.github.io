...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------- | ---------- | ----------- | ------- |
| [infra-advisor-ai](https://github.com/kyletaylored/infra-advisor-ai)                        | Agentic AI platform example built on Azure and Datadog.                                           | Python     | Public     | 2026-07-16  | Published |
...
| [datadog-rum-pizza-builder](https://github.com/kyletaylored/datadog-rum-pizza-builder)             | Educational environment of how Datadog RUM works with fragments and actions.                             | JavaScript | Public     | 2026-04-17  | Published |
...
| [dd-sdk-maui](https://github.com/kyletaylored/dd-sdk-maui) ★1                                      | Datadog Mobile SDK for .NET MAUI.                                                                        | C#         | Public     | 2026-03-06  | Published |
...
| [datadog-rum-interceptor](https://github.com/kyletaylored/datadog-rum-interceptor) ★2              | A lightweight request/response interceptor to provide payload visibility for debugging and monitoring.   | JavaScript | Public     | 2025-02-04  | Published |
