...
- **Article** (`src/content/articles/`) — the *how/why* is the interesting
...
| [chaotic-coaster](https://github.com/kyletaylored/chaotic-coaster) | An interactive and playful smart coaster powered by a Raspberry Pi Pico. | Python | Public | 2024-12-16 | Backlog |
| [piodome](https://github.com/kyletaylored/piodome) ★1 | Hydroponics monitoring project to chart and display humidity, temperature, and light using a Raspberry Pi Zero. | Python | Public | 2023-05-22 | Backlog |
...
| [maccron](https://github.com/kyletaylored/maccron) | A simple GUI for managing cron tasks | Python | Public | 2025-03-20 | Backlog |
| [colima-gui](https://github.com/kyletaylored/colima-gui) ★52 | A simple GUI for managing Colima on MacOS. | Rust | Public | 2025-03-20 | Backlog |
...
| [traceroute-to-geo](https://github.com/kyletaylored/traceroute-to-geo) | Map a traceroute to geolocations on a map. | HTML | Public | 2024-05-03 | Backlog |
...
| [randomross](https://github.com/kyletaylored/randomross) | Provides a random painting from Bob Ross. | JavaScript | Public | 2024-10-18 | Backlog |
...
| [carnac](https://github.com/kyletaylored/carnac) ★3 | A magic machine that reads Reddit for trends. | HTML | Public | 2019-05-08 | Backlog |
...
| [isitgreenorblue](https://github.com/kyletaylored/isitgreenorblue) | Is the color green or blue? A helpful tool for the colordumb. | Ruby | Public | 2017-07-24 | Backlog |
